...
export const SkillsItemSolo: React.FC<SkillsItemProps> = ({ item }) => {
  ...
  return (
    <div className="p-2 md:p-4  border border-transparent bg-sky-200 hover:border hover:border-sky-500 rounded-lg transition-all flex items-center h-full gap-3">
