		...
		<>
			<div className="flex items-center justify-center h-full min-h-screen">
				<div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-16">
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12">
						...
						<div>
							...
							<p className="mb-6 text-stone-950 max-w-md">
								Feel free to reach out if you have any questions or want to work together. I'm always
					...
					<div className="mt-12 pt-8 border-t border-stone-950 text-center">
						<p className="text-stone-950">
							© {new Date().getFullYear()} <span className="font-bold">Ajeeth</span>
							<span className="font-bold text-green-400">Muthu</span>.
						</p>
					</div>
				</div>
			</div>
